...
#Função que cria a Matrix Quadrado Magico (Bem condicionada)
...
#Função que cria a Matrix de Hilbert (Mal condicionada)
def hilbert(n):
    H = np.zeros((n, n))
...
#Fatoração Gram-Schmidt Modificado
def fatoração_GS(A):
...
if __name__ == '__main__':
    ...
    print("\nFatoração por Gram-Schmidt Classico\n")
    for i in range(0,len(N)):
        ...
        condição = np.linalg.cond(A_fatoração_QR)
        print(f"{n} & {tempo:.3e} & {norma_fatoração_QR:.3e} & {norma_qualidade_QR:.3e} & {condição:.3e} \\\\ \n")
    ...
    for i in range(0,len(N)):
        ...
        condição = np.linalg.cond(A_fatoração_GS)
        print(f"{n} & {tempo:.3e} & {norma_fatoração_GS:.3e} & {norma_qualidade_GS:.3e} & {condição:.3e} \\\\ \n")
    ...
    for i in range(0,len(N)):
        ...
        condição = np.linalg.cond(A_fatoração_RH)
        print(f"{n} & {tempo:.3e} & {norma_fatoração_RH:.3e} & {norma_qualidade_RH:.3e} & {condição:.3e} \\\\ \n")
